...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView (@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FootballCardRecyclerViewAdapter adapter = new FootballCardRecyclerViewAdapter(
                FootballEntry.initProductEntryList(getResources()));
        ...
        recyclerView.addItemDecoration(new FootballGridItemDecoration(largePadding, smallPadding));
